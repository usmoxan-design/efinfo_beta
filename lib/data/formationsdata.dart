...
final List<Formation> allFormations = [
  ...
  positions: [
    ...
    [0.65, 0.72], // RCB
    [0.85, 0.75], // RB
    [0.3, 0.52],  // LCM (chap CMF)
    [0.5, 0.48],  // CCM (markaziy CMF/Orchestrator)
    [0.7, 0.52],  // RCM (o'ng CMF)
    [0.35, 0.28], // LCF (chap AMF)
    [0.65, 0.28], // RCF (o'ng AMF)
    [0.5, 0.12],  // CF (markaziy)
  ],
...
const Formation(
  ...
  bestFor: 
      "• Quick Counter va Possession uchun ideal (markaziy hujumlar)\n"
  ...
  positions: [
    ...
    [0.85, 0.75], // RB
    [0.4, 0.52],  // LCM
    [0.5, 0.48],  // CDM (markaziy/DMF)
    [0.6, 0.52],  // RCM
    [0.5, 0.3],   // AMF (markaziy)
    [0.45, 0.15], // LCF
    [0.55, 0.15], // RCF
  ],
...
const Formation(
  ...
  positions: [
    ...
    [0.65, 0.72], // RCB
    [0.85, 0.75], // RB
    [0.35, 0.52], // LDMF (Anchorman deep)
    [0.65, 0.52], // RDMF (B2B)
    [0.5, 0.32],  // AMF (markaziy)
    [0.2, 0.22],  // LWF (qanot)
    [0.5, 0.15],  // CF (markaz)
    [0.8, 0.22],  // RWF (qanot)
  ],
...
const Formation(
  ...
  positions: [
    ...
    [0.7, 0.75],  // RCB
    [0.2, 0.5],   // LMF (wide left)
    [0.4, 0.52],  // LCM
    [0.6, 0.52],  // RCM
    [0.8, 0.5],   // RMF (wide right)
    [0.18, 0.25], // LWF
    [0.5, 0.18],  // CF
    [0.82, 0.25], // RWF
  ],
...
const Formation(
  ...
  positions: [
    ...
    [0.35, 0.52], // LDMF
    [0.65, 0.52], // RDMF
    [0.2, 0.4],   // LMF (wide left)
    [0.5, 0.35],  // AMF
    [0.8, 0.4],   // RMF (wide right)
    [0.5, 0.18],  // CF
  ],
...
const Formation(
  ...
  positions: [
    ...
    [0.35, 0.52], // LDMF
    [0.65, 0.52], // RDMF
    [0.25, 0.38], // LMF (chap AMF/wide)
    [0.5, 0.35],  // AMF (markaziy)
    [0.75, 0.38], // RMF (o'ng AMF/wide)
    [0.45, 0.15], // LCF
    [0.55, 0.15], // RCF
  ],
...
const Formation(
  ...
  bestFor: 
      "• Long Ball Counter uchun ideal (super long ball wide mids ga)\n"
  ...
  positions: [
    ...
    [0.5, 0.72],  // CB (markaziy)
    [0.7, 0.75],  // RCB
    [0.5, 0.52],  // DMF (markaziy anchorman)
    [0.2, 0.4],   // LMF (wide left)
    [0.4, 0.38],  // LCM
    [0.6, 0.38],  // RCM
    [0.8, 0.4],   // RMF (wide right)
...
const Formation(
  ...
  positions: [
    ...
    [0.7, 0.75],  // RCB
    [0.85, 0.78], // RWB
    [0.3, 0.55],  // LCM (Anchorman)
    [0.5, 0.52],  // CCM (B2B)
    [0.7, 0.55],  // RCM (Orchestrator)
    [0.45, 0.18], // LCF
    [0.55, 0.18], // RCF
  ],
...
const Formation(
  ...
  bestFor: 
      "• Long Ball Counter uchun ideal (super long ball LMF/RMF ga)\n"
  ...
  positions: [
    ...
    [0.7, 0.75],  // RCB
    [0.85, 0.78], // RWB
    [0.35, 0.55], // LDMF (Anchorman)
    [0.65, 0.55], // RDMF (B2B)
    [0.25, 0.35], // LMF (chap AMF)
    [0.75, 0.35], // RMF (o'ng AMF)
    [0.5, 0.15],  // CF
  ],
...
const Formation(
  ...
  positions: [
    ...
    [0.65, 0.72], // RCB
    [0.85, 0.75], // RB
    [0.35, 0.52], // LDMF (Anchorman)
    [0.65, 0.52], // RDMF (B2B)
    [0.4, 0.32],  // LMF/AMF (chap)
    [0.6, 0.32],  // RMF/AMF (o'ng)
    [0.45, 0.15], // LCF
    [0.55, 0.15], // RCF
  ],
...
///oxirgisi
  const Formation(
    ...
    positions: [
      ...
      [0.15, 0.78], // LB (LWB)
      [0.35, 0.75], // LCB
      [0.5, 0.72], // CBF (Oldinga chiqadigan markaziy himoyachi!!!)
      [0.65, 0.75], // RCB
      [0.85, 0.78], // RB (RWB)
      [0.35, 0.55], // LDMF
      [0.65, 0.55], // RDMF
      [0.5, 0.35], // AMF (juda oldinga yaqin joylashadi)
      [0.42, 0.15], // LCF
      [0.58, 0.15], // RCF
    ],
    warning: "Diqqat:\n"
